...
def test_1_three_of_a_kind_ranks():
    compare_input_to_expected_result("AC AS 5C 10C AH 2H 5H", "LOSE")

def test_1_three_of_a_kind_ranks_and_four_others_all_different():
...
def test_three_and_four_of_a_kind_ranks():
    compare_input_to_expected_result("KC KS 10S 10C KH KD 10H", "WIN")

def test_three_and_four_of_a_kind_ranks_with_aces():
    compare_input_to_expected_result("AC AS 10S 10C AH AD 10H", "WIN")

def test_1_straight_three_cards():
    compare_input_to_expected_result("AH 2H 3H 4C 5S 6D 7H", "LOSE")

def test_1_straight_four_cards():
    compare_input_to_expected_result("AH 2H 3H 4H 5S 6D 7H", "LOSE")

# def test_straight_four_and_three_together():
#     compare_input_to_expected_result("AH 2H 3H 4H 5S 6S 7S", "WIN")
